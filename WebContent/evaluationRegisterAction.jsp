...
<% 
	...
	if(lectureName == null || lectureName.equals("") || professorName == null ||  professorName.equals("") 
			...
			|| totalScore == null || totalScore.equals("") || creditScore == null || creditScore.equals("")
			|| comfortableScore == null || comfortableScore.equals("") || lectureScore == null || lectureScore.equals("")){
		PrintWriter script = response.getWriter();
		script.println("<script>");
